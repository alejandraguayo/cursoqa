...
Un constructor que reciba los valores para la marca, modelo y año, y
los asigne a las propiedades correspondientes.
Métodos get para obtener los valores de las propiedades marca,
modelo y año.
Métodos acelerar() y frenar() que simplemente impriman un mensaje
indicando la acción.
